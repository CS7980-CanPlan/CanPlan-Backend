...
/** The Cognito group that maps to the PRIMARY_USER role (self-signup users). */
export const PRIMARY_USER_GROUP = 'PrimaryUser';
 ...
 * primary users and to act on a selected primary user's schedule via an effective SupportLink.
